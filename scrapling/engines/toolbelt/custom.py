...
class Response(Adaptor):
    ...
    def __init__(self, url: str, text: str, body: bytes, status: int, reason: str, cookies: Dict, headers: Dict, request_headers: Dict, history: List, encoding: str = 'utf-8', **adaptor_arguments: Dict):
